<?php
// ============================================================
// monthly-stats.php — Returns previous month's pageviews for
// /topic/*/?oref=d1-article-topics links via GA4 Data API.
...
$payload = json_encode([
    ...
    'dimensionFilter' => [
        'filter' => [
            ...
            'stringFilter' => ['matchType' => 'CONTAINS', 'value' => 'oref=d1-article-topics'],
        ],
    ],
]);
